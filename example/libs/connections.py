...
def lrelu(x, leak=0.2, name="lrelu"):
    ...
    Parameters
        x : Tensor  The tensor to apply the nonlinearity to.
        leak : float, optional  Leakage parameter.
        name : str, optional    Variable scope to use.

    Returns
        x : Tensor  Output of the nonlinearity.
    """
...
def linear(x, n_units, scope=None, stddev=0.02, activation=lambda x: x):
    ...
    Parameters
        ...
        scope : str, optional   Variable scope to use.
        stddev : float, optional    Initialization's standard deviation.
        activation : arguments, optional    Function which applies a nonlinearity
    Returns
        x : Tensor  Fully-connected output.
    """
    shape = x.get_shape().as_list()
...
def conv2d(x, n_filters,
    ...
    """
        ...
        Parameters
            x : Tensor      Input tensor to convolve.
            n_filters : int     Number of filters to apply.
            k_h : int, optional     Kernel height.
            k_w : int, optional     Kernel width.
            stride_h : int, optional    Stride in rows.
            stride_w : int, optional    Stride in cols.
            stddev : float, optional    Initialization's standard deviation.
            activation : arguments, optional    Function which applies a nonlinearity

...
def montage_batch(images):
    ...
    Parameters
        batch : numpy.ndarray   Input array to create montage of.

    Returns
        m : numpy.ndarray   Montage image.
    """
...
def montage(W):
    ...
    Parameters
        W : numpy.ndarray   Input array to create montage of.
...
def corrupt(x):
    ...
    Parameters
        x : Tensor/Placeholder  Input to corrupt.

    Returns
        x_corrupted : Tensor    50 pct of values corrupted.
    """

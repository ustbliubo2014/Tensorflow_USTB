...
class Siamese:
    ...
    def loss(self, labels):
        margin = 3.0
        labels_t = labels
        labels_f = tf.sub(1.0, labels, name='1-y')
    ...
    def loss_with_step(self, labels):
        margin = 3.0
        labels_t = labels
        labels_f = tf.sub(1.0, labels, name='1-yi')
